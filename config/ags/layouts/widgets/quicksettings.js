...
const { Bluetooth, Battery, Brightness, Audio, Network, Theme } = Service;
...
const BrightnessBox = () => Box({
    ...
    connections: [[Brightness, box => {
        box.visible = Brightness.available;
    }]]
});
